...
for i in range(9):
    if i % 2 == 1:
        ...
        gameX()
        field()
        if ((stepX.count(1) and stepX.count(2) and stepX.count(3)) == 1) or ((stepX.count(1) and stepX.count(4) and stepX.count(7)) == 1) or ((stepX.count(1) and stepX.count(5) and stepX.count(9)) == 1) or ((stepX.count(2) and stepX.count(5) and stepX.count(8)) == 1) or ((stepX.count(3) and stepX.count(6) and stepX.count(9)) == 1) or ((stepX.count(4) and stepX.count(5) and stepX.count(6)) == 1) or ((stepX.count(7) and stepX.count(8) and stepX.count(9)) == 1) or ((stepX.count(3) and stepX.count(5) and stepX.count(7)) == 1):
